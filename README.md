...
| Projeto | Descrição | Data |
| -------- | ---------- | ---- |
| [🧮 Calculator](https://github.com/mateushrc/calculator-csharp) | Console calculator with basic operations. | 01/11/2025 |
| [📝 Text Editor](https://github.com/mateushrc/texteditor-csharp) | Console text editor for creating and editing files. | 02/11/2025 |
| [⏱️ Stopwatch](https://github.com/mateushrc/stopwatch-csharp) | Simple stopwatch to measure elapsed time in the console. | 03/11/2025 |
| [🔐 Password Generator](https://github.com/mateushrc/passwordgenerator-csharp) | Generates strong and secure random passwords. | 04/11/2025 |
